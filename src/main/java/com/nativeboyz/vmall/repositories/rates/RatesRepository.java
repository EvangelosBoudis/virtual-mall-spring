...
public interface RatesRepository extends JpaRepository<RateEntity, CustomerProductIdentity>, JpaSpecificationExecutor<RateEntity> {
    ...
    Float findProductAvgRate(@Param("id") UUID id);
